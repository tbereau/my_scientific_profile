...
```{bibtex}
@article{Kleinw_chter_2022,
	doi = {10.1039/d2cb00125j},
	url = {https://doi.org/10.1039%2Fd2cb00125j},
	year = 2022,
	publisher = {Royal Society of Chemistry ({RSC})},
	volume = {3},
	number = {7},
	pages = {941--954},
	author = {Isabel Kleinwächter and Bernadette Mohr and Aljoscha Joppe and Nadja Hellmann and Tristan Bereau and Heinz D. Osiewacz and Dirk Schneider},
	title = {{CLiB} {\textendash} a novel cardiolipin-binder isolated $\less$i$\greater$via$\less$/i$\greater$ data-driven and $\less$i$\greater$in vitro$\less$/i$\greater$ screening},
