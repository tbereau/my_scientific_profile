...
It is found that the interplay between secondary structure and the loss of non-native tertiary contacts that determines the nature of the transition between thermodynamics and structure for helical peptides using a high-resolution coarse-grained model.
```{=html}
<footer class="blockquote-footer">from
...
@article{Bereau_2010,
	doi = {10.1021/ja105206w},
	url = {https://doi.org/10.1021%2Fja105206w},
	year = 2010,
	month = {sep},
	...
	number = {38},
	pages = {13129--13131},
	author = {Tristan Bereau and Michael Bachmann and Markus Deserno},
	title = {Interplay between Secondary and Tertiary Structure Formation in Protein Folding Cooperativity},
